...
public class TracksParser implements DocumentHandler {
    ...
    public final void startElement(java.lang.String name,
        ...
        if ("start".equals(name)) {
            handler.handle_start(attrs);
        } else if ("trail".equals(name)) {
            handler.start_trail(attrs);
        } else if ("trails".equals(name)) {
            handler.start_trails(attrs);
        }
    }
    ...
    private void dispatch(final boolean fireOnlyIfMixed) throws SAXException {
        ...
        if ("difficulty".equals(here)) {
            if (fireOnlyIfMixed) {
                throw new IllegalStateException(
                        "Unexpected characters() event! (Missing DTD?)");
            }
            handler.handle_difficulty(buffer.length() == 0 ? null : buffer
                    .toString(), attrs);
        } else if ("downHill".equals(here)) {
            if (fireOnlyIfMixed) {
                throw new IllegalStateException(
                        "Unexpected characters() event! (Missing DTD?)");
            }
            handler.handle_downHill(buffer.length() == 0 ? null : buffer
                    .toString(), attrs);
        } else if ("uphill".equals(here)) {
            if (fireOnlyIfMixed) {
                throw new IllegalStateException(
                        "Unexpected characters() event! (Missing DTD?)");
            }
            handler.handle_uphill(buffer.length() == 0 ? null : buffer
                    .toString(), attrs);
            ...
            handler.handle_title(buffer.length() == 0 ? null : buffer
                    .toString(), attrs);
        } else if ("created".equals(here)) {
            if (fireOnlyIfMixed) {
                throw new IllegalStateException(
                        "Unexpected characters() event! (Missing DTD?)");
            }
            handler.handle_created(buffer.length() == 0 ? null : buffer
                    .toString(), attrs);
        ...
        } else if ("owner".equals(here)) {
            if (fireOnlyIfMixed) {
                throw new IllegalStateException(
                        "Unexpected characters() event! (Missing DTD?)");
            }
            handler.handle_owner(buffer.length() == 0 ? null : buffer
                    .toString(), attrs);
        } else if ("rating".equals(here)) {
            if (fireOnlyIfMixed) {
                throw new IllegalStateException(
                        "Unexpected characters() event! (Missing DTD?)");
            }
            handler.handle_rating(buffer.length() == 0 ? null : buffer
                    .toString(), attrs);
            ...
            handler.handle_activity(buffer.length() == 0 ? null : buffer
                    .toString(), attrs);
        } else if ("tps".equals(here)) {
            if (fireOnlyIfMixed) {
                throw new IllegalStateException(
                        "Unexpected characters() event! (Missing DTD?)");
            }
            handler.handle_tps(buffer.length() == 0 ? null : buffer.toString(),
                    attrs);
        } else {
        }
    ...
    public static void parse(final org.xml.sax.InputSource input,
            final TracksHandler handler) throws SAXException,
            ParserConfigurationException, IOException {
        parse(input, new TracksParser(handler, null));
    }
     ...
     *             if the implementation cannot be instantiated
     */
    public static void parse(final java.net.URL url, final TracksHandler handler)
    ...
    private static void parse(final org.xml.sax.InputSource input,
            final TracksParser recognizer) throws SAXException,
            ParserConfigurationException, IOException {
