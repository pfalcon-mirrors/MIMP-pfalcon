...
public abstract class DrivingDirections
{
	 ...
	 */
	public void driveTo (Vector<GeoPoint> points, Mode mode, IDirectionsListener listener)
	{
		if ((points == null) || (points.get(0) == null) || (points.get(1) == null) || (mode == null)) {
	 ...
	 * @param listener The object to be notified when the directions are available. It can be null.
	 */
	protected abstract void startDrivingTo (Vector<GeoPoint> points, Mode mode, IDirectionsListener listener); 
