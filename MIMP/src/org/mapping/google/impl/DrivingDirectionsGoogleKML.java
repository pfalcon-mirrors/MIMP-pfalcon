...
{
	@Override
	protected void startDrivingTo (Vector<GeoPoint> points, Mode mode, IDirectionsListener listener)
	{
	...
	private class LoadDirectionsTask extends AsyncTask<Mode, Void, RouteImpl>
	{
		...
		protected RouteImpl doInBackground(Mode... params)
		{
			...
			urlString
				.append(BASE_URL)
				.append("&saddr=")
				.append(points.get(0).getLatitudeE6() / 1E6)
				.append(",")
				.append(points.get(0).getLongitudeE6() / 1E6)
				.append("&daddr=")
				.append(points.get(1).getLatitudeE6() / 1E6)
				.append(",")
